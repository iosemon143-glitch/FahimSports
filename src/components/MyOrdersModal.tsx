    ...
    switch (status) {
      case 'shipped':
        return {
          ...
          icon: <Truck className="w-3.5 h-3.5 animate-bounce" />,
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center pointer-events-auto">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[420px] bg-[#F8F9FD] rounded-t-[36px] sm:rounded-[36px] shadow-2xl p-5 sm:p-6 z-10 max-h-[88vh] flex flex-col no-scrollbar select-none"
          >
            {/* Grab Handle */}
                ...
                filteredOrders.map((order) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-white rounded-3xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.04)] border border-gray-100 space-y-3.5"
                    >
                      {/* Order Header info */}
            ...
            <div className="pt-2 border-t border-gray-200 flex items-center justify-between text-[11px] text-gray-500 flex-shrink-0">
              ...
              <span className="font-bold text-[#FF6B00]">Fahim Sports Hub</span>
            </div>
          </motion.div>
        </div>
      )}
