  ...
  const [chatMessages, setChatMessages] = useState<Array<{ id: string; sender: 'bot' | 'user'; text: string; time: string }>>([
    {
      id: '1',
      sender: 'bot',
      text: 'Hello! I am your NEXT LEVEL Gear specialist. Ask me anything about jersey sizes, cleat studs, bat weights, or delivery.',
      time: '9:41 AM',
    },
  ]);
  ...
  if (activeTab === 'messages') {
    return (
      <div className="w-full pt-2 px-4 pb-6 space-y-4 select-none">
        ...
        <div className="space-y-3">
          <div className="nl-card bg-white rounded-2xl p-4 border border-gray-100 shadow-sm flex items-start space-x-3">
          ...
          <div className="nl-card bg-white rounded-2xl p-4 border border-gray-100 shadow-sm flex items-start space-x-3">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between">
                <h4 className="text-xs font-bold text-[#141416]">Order updates</h4>
                <span className="text-[10px] text-gray-400">2h ago</span>
              </div>
              <p className="text-xs text-gray-600 mt-0.5">
                Your latest order status will appear here after you place an order.
              </p>
            </div>
          </div>
        </div>
    ...
    return (
      <div className="w-full pt-2 px-4 pb-6 space-y-4 select-none">
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            href="https://wa.me/8801405398188?text=Hi%20NEXT%20LEVEL%20I%20need%20gear%20advice"
            target="_blank"
        ...
        {/* Message Thread */}
        <div className="nl-card bg-white rounded-[28px] p-4 border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] space-y-3 min-h-[300px] flex flex-col justify-between">
          <div className="space-y-3 overflow-y-auto max-h-[360px] pr-1 no-scrollbar">
                ...
                <div
                  className={`max-w-[78%] px-3.5 py-2.5 rounded-[20px] text-xs font-medium leading-relaxed ${
                    msg.sender === 'user'
                      ...
                      : 'nl-chat-bot bg-[#F4F6F9] text-[#141416] rounded-bl-xs'
                  }`}
                >
                  <p>{msg.text}</p>
                  <span
            ...
            {isTyping && (
              ...
              >
                <div className="nl-typing-dots flex items-center gap-1 py-1.5 px-3 bg-gray-100 rounded-full">
                  <span className="w-1.5 h-1.5 bg-gray-400 rounded-full " />
                  <span className="w-1.5 h-1.5 bg-gray-400 rounded-full " />
                  <span className="w-1.5 h-1.5 bg-gray-400 rounded-full " />
                </div>
                <span className="text-[11px] font-medium text-gray-400">Coach is replying…</span>
              </motion.div>
            )}
          </div>
          ...
          >
            <input
              ...
              className="nl-chat-input flex-1 bg-[#F3F4F8] text-xs font-medium text-[#141416] placeholder-gray-400 px-4 py-3 rounded-full border border-transparent focus:border-[#FF6B00]/50 focus:bg-white focus:outline-none transition-all"
            />
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-[11px] font-bold text-[#1877F2] bg-blue-50 px-2.5 py-0.5 rounded-full border border-blue-100">
          Official Page
        </span>
      </div>
      ...
      <div className="bg-white rounded-3xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.05)] border border-gray-100 space-y-3.5">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-gray-500 font-medium">Sporting Goods & NEXT LEVEL • Official Page</p>
            <p className="text-[11px] text-gray-400 mt-0.5">@fahimkhelaghor</p>
          </div>
        </div>

        <div className="nl-card bg-[#F7F9FD] rounded-2xl p-3 border border-blue-50 text-xs text-gray-600">
          <div className="flex items-center gap-2 font-bold text-[#141416]">
            <ThumbsUp className="w-4 h-4 text-[#1877F2]" />
            <span>Follow the official Facebook Page for the latest updates.</span>
          </div>
        </div>
      ...
      <div className="bg-white rounded-3xl p-4 shadow-[0_4px_16px_rgba(0,0,0,0.05)] border border-gray-100 space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              ...
              <span className="text-[10px] text-gray-400">Public post</span>
            </div>
          </div>
        </div>

        {/* Post Caption */}
        <p className="nl-facebook-copy text-xs text-gray-700 leading-relaxed font-normal">
        ...
        <div className="nl-facebook-meta flex items-center justify-between text-[11px] text-gray-500 pt-1 border-t border-gray-100">
          <div className="flex items-center space-x-1">
            ...
            <span className="font-bold text-gray-700">{postLikes} reactions</span>
          </div>
